...
const s = StyleSheet.create({
  ...
  directionPastille: { borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5, backgroundColor: "rgba(0,79,145,0.08)" },
  ...
  paysPastille: {
    ...
    borderColor: "rgba(0,79,145,0.18)", backgroundColor: "rgba(0,79,145,0.05)",
