...
// La bascule segmentée a migré vers `components/shared/Segments` : la page
// publique s'en sert aussi. Ré-exportée ici pour ne pas toucher aux appelants.
export { Segments } from "@/components/shared/Segments";
