            ...
            <div style={{ position: "relative" }} onMouseEnter={openUser} onMouseLeave={closeUser}>
              ...
              {userOpen && (
                <div onMouseEnter={openUser} onMouseLeave={closeUser}
                  ...
                  style={{ position: "absolute", top: "calc(100% + 10px)", right: 0, width: 280, background: "#fff", border: "1px solid rgba(16,26,46,0.08)", borderRadius: 16, padding: 7, boxShadow: "0 24px 64px rgba(16,26,46,0.16), 0 4px 12px rgba(16,26,46,0.06)", zIndex: 50, transformOrigin: "top right" }}>
