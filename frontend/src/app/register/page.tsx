        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 408, display: "flex", justifyContent: "center" }}>
          ...
          <div className="login-card" style={{ width: "100%", maxWidth: 408, background: "var(--carte)", borderRadius: 20, overflow: "hidden", border: "1px solid rgb(var(--bleu-rgb) / 0.10)", boxShadow: "0 30px 70px rgb(var(--ombre-rgb) / 0.35), 0 4px 14px rgb(var(--ombre-rgb) / 0.12)", position: "relative" }}>
            ...
            <div style={{ padding: "30px 34px 28px", textAlign: "center" }}>
              ...
              <h1 style={{ fontWeight: 800, fontSize: "1.25rem", color: "var(--encre)", letterSpacing: "-0.02em", margin: 0 }}>Compte créé</h1>
              <p style={{ color: "var(--texte)", fontSize: 13.5, marginTop: 10, lineHeight: 1.65 }}>
              ...
              <Link href="/login" className="login-cta"
                style={{ display: "inline-flex", alignItems: "center", gap: 8, justifyContent: "center", marginTop: 20, height: 44, padding: "0 26px", borderRadius: 12, background: "var(--bleu-action)", color: "var(--sur-bleu)", fontWeight: 700, fontSize: 14, textDecoration: "none", boxShadow: "0 4px 18px rgb(var(--ombre-rgb) / 0.35)" }}>
                Retour à la connexion <ArrowRight size={15} className="cta-arrow" />
              </Link>
            </div>
            ) : (
            <div style={{ padding: "26px 34px 24px" }}>
              <h1 style={{ fontWeight: 800, fontSize: "1.5rem", color: "var(--encre)", letterSpacing: "-0.02em", margin: 0 }}>Créer un compte</h1>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 13, marginTop: 20 }}>
                <div>
                  <label style={{ display: "block", fontSize: 10.5, fontWeight: 800, letterSpacing: "0.1em", color: "var(--bleu)", textTransform: "uppercase", marginBottom: 6 }}>Adresse email</label>
                  <div className="login-field">
                    ...
                    <input
                      ...
                      style={{ width: "100%", height: 43, padding: "0 14px 0 42px", border: "1.5px solid var(--bordure-forte)", borderRadius: 12, fontSize: 14, color: "var(--encre)", background: "var(--carte-douce)", fontFamily: "var(--font-google-sans)", boxSizing: "border-box" }}
                    />
                  </div>
                </div>

                <div>
                  <label style={{ display: "block", fontSize: 10.5, fontWeight: 800, letterSpacing: "0.1em", color: "var(--bleu)", textTransform: "uppercase", marginBottom: 6 }}>Mot de passe</label>
                  <div className="login-field">
                    ...
                    <input
                      ...
                      style={{ width: "100%", height: 43, padding: "0 44px 0 42px", border: "1.5px solid var(--bordure-forte)", borderRadius: 12, fontSize: 14, color: "var(--encre)", background: "var(--carte-douce)", fontFamily: "var(--font-google-sans)", boxSizing: "border-box" }}
                    />
                ...
                {password && (
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3px 12px", margin: "-4px 2px 0" }}>
                    {regles.map(r => (
                      <span key={r.l} style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 10.5, fontWeight: 600, color: r.ok ? "var(--vert)" : "var(--gris)", transition: "color 0.15s" }}>
                        <span style={{ width: 12, height: 12, borderRadius: "50%", background: r.ok ? "rgb(var(--vert-rgb) / 0.12)" : "var(--fond-creux)", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 8, lineHeight: 1, flexShrink: 0 }}>{r.ok ? "✓" : ""}</span>
                        {r.l}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  <label style={{ display: "block", fontSize: 10.5, fontWeight: 800, letterSpacing: "0.1em", color: "var(--bleu)", textTransform: "uppercase", marginBottom: 6 }}>Confirmer le mot de passe</label>
                  <div className="login-field">
                ...
                <button type="submit" disabled={loading} className="login-cta"
                  style={{ width: "100%", height: 46, borderRadius: 12, border: "none", cursor: "pointer", background: "var(--bleu-action)", color: "var(--sur-bleu)", fontWeight: 700, fontSize: 14.5, letterSpacing: "0.01em", boxShadow: "0 4px 18px rgb(var(--ombre-rgb) / 0.35)", fontFamily: "var(--font-google-sans)", marginTop: 2 }}>
                  {loading ? (
            ...
            {/* Pied de carte */}
            <div style={{ padding: "12px 34px", borderTop: "1px solid var(--bordure)", background: "var(--carte-douce)", textAlign: "center", fontSize: 13, color: "var(--gris-fort)" }}>
              Déjà un compte ?{" "}
