      ...
      <div style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px" }}>
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 408, display: "flex", justifyContent: "center" }}>
          ...
          <div className="login-card" style={{ width: "100%", maxWidth: 408, background: "#fff", borderRadius: 20, overflow: "hidden", border: "1px solid rgba(0,79,145,0.10)", boxShadow: "0 30px 70px rgba(0,20,45,0.35), 0 4px 14px rgba(0,20,45,0.12)", position: "relative" }}>
                ...
                <div>
                  ...
                  <div className="login-field">
                    ...
                    <input
                      ...
                      style={{ width: "100%", height: 45, padding: "0 14px 0 42px", border: "1.5px solid #E8E5E3", borderRadius: 12, fontSize: 14, color: "#1a1a2e", background: "#F8F7F6", fontFamily: "var(--font-google-sans)", boxSizing: "border-box" }}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="login-field">
                    ...
                    <input
                      ...
                      style={{ width: "100%", height: 45, padding: "0 44px 0 42px", border: "1.5px solid #E8E5E3", borderRadius: 12, fontSize: 14, color: "#1a1a2e", background: "#F8F7F6", fontFamily: "var(--font-google-sans)", boxSizing: "border-box" }}
                    />
            ...
            {/* Pied de carte */}
            <div style={{ padding: "13px 34px", borderTop: "1px solid #F2F0EF", background: "#FCFBFA", textAlign: "center", fontSize: 13, color: "#6b7280" }}>
              Pas encore de compte ?{" "}
              <Link href="/register" className="login-link" style={{ color: "#004f91", fontWeight: 700, textDecoration: "none" }}>
                Créer un compte
              </Link>
            </div>
          </div>
