    ...
    <div style={{ padding: "32px 40px 80px", maxWidth: 1100, margin: "0 auto", fontFamily: "var(--font-google-sans)" }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ position: "relative", width: "min(340px, 100%)" }}>
          <Search size={14} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "var(--gris)" }} />
          ...
          <div key={t.id} style={{ display: "grid", gridTemplateColumns: COLS, gap: 0, padding: "13px 18px", borderBottom: "1px solid var(--bordure)", alignItems: "center", opacity: t.actif === false ? 0.5 : 1 }}>
            ...
            <span style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
              ...
              <button onClick={() => setASupprimer(t)} title="Supprimer"
                style={{ width: 32, height: 32, borderRadius: 8, border: "1px solid rgb(var(--danger-rgb) / 0.25)", background: "var(--carte)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--danger)" }}>
                <Trash2 size={14} />
              </button>
            </span>
          </div>
