      ...
      <main style={{ flex: 1, padding: "40px 48px" }}>
        <div style={{ marginBottom: 32 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
            ...
            <h1 style={{ fontSize: "var(--t-r160)", fontWeight: 800, color: "var(--encre)" }}>Analyse de données</h1>
          </div>
          <p style={{ fontSize: "var(--t-14)", color: "var(--gris)" }}>Tableaux de bord analytiques et indicateurs avancés.</p>
        </div>
        ...
        <div style={{ background: "var(--carte)", borderRadius: 16, border: "1px solid var(--bleu-voile)", padding: "60px 40px", textAlign: "center" }}>
          ...
          <h2 style={{ fontWeight: 700, fontSize: "var(--t-r120)", color: "var(--encre)", marginBottom: 10 }}>Module en cours de développement</h2>
          <p style={{ fontSize: "var(--t-14)", color: "var(--gris)", maxWidth: 420, margin: "0 auto", lineHeight: 1.7 }}>
