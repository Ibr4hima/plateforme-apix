...
function LierModal({ classe, systeme, onClose, onSaved }: {
  ...
  const color = systeme === "citi" ? "var(--bleu)" : "var(--violet)";

  return (
    <div onClick={e => { if (e.target === e.currentTarget) onClose(); }}
      style={{ position: "fixed", inset: 0, background: "rgb(var(--ombre-rgb) / 0.5)", backdropFilter: "blur(8px)", zIndex: 400, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ background: "var(--carte-douce)", borderRadius: 20, width: "100%", maxWidth: 600, maxHeight: "88vh", border: "1px solid var(--bordure-forte)", boxShadow: "var(--ombre-2)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
        <div style={{ height: 4, background: `linear-gradient(90deg,${color},var(--orange-action))` }} />
...
function OngletClassification({ systeme }: { systeme: "citi" | "nace" }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
      {/* Liste classes */}
      <div style={{ width: 420, flexShrink: 0, borderRight: "1px solid var(--bordure-forte)", background: "var(--carte)", display: "flex", flexDirection: "column" }}>
        <div style={{ padding: "12px 14px", borderBottom: "1px solid var(--bordure)" }}>
          {stats && (
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
              ...
              <div style={{ width: 100, height: 5, background: "var(--fond)", borderRadius: 999, overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          {loading ? (
            <div style={{ display: "flex", justifyContent: "center", padding: 48 }}>
              <Loader2 size={24} style={{ color: "var(--gris)", animation: "spin 1s linear infinite" }} />
            </div>
      ...
      {/* Panneau détail */}
      <div style={{ flex: 1, background: "var(--carte-douce)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
        {selectedClass ? (
          <>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "16px 22px" }}>
              {corrsLoad ? (
                <div style={{ display: "flex", justifyContent: "center", padding: 40 }}>
                  <Loader2 size={22} style={{ color: "var(--gris)", animation: "spin 1s linear infinite" }} />
                </div>
              ) : corrs.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", color: "var(--gris)" }}>
...
export default function AdminClassifications() {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", fontFamily: "var(--font-google-sans)", background: "var(--champ)" }}>
      ...
      <div style={{ padding: "20px 32px 0", background: "var(--carte)", borderBottom: "1px solid var(--bordure-forte)" }}>
        ...
        <div style={{ display: "flex", marginTop: 16 }}>
          {([
            { key: "citi", label: "CITI Rév.4 ↔ NAEMA", color: "var(--bleu)" },
