...
export const CATALOGUE: Visualisation[] = [
  ...
  {
    id: "ent_par_forme",
    titre: "Entreprises par forme juridique",
    description: "SA, SARL, SAS et autres formes",
    categorie: "entreprises",
    endpoint: "/dashboard/viz/entreprises-par-forme",
    defaultSize: "sm",
  },
  {
    id: "ent_par_annee",
  ...
  {
    id: "zones_par_type",
    titre: "Zones d'investissement par type",
    description: "Répartition ZES / ZAI / ZFI",
    categorie: "zones",
    endpoint: "/dashboard/viz/zones-par-type",
    defaultSize: "sm",
  },
  {
    id: "zones_superficie",
    titre: "Superficie par type de zone",
    description: "Surface totale en hectares par type",
    categorie: "zones",
    endpoint: "/dashboard/viz/zones-superficie",
    defaultSize: "sm",
  },
  {
    id: "zones_par_region",
    titre: "Zones par région",
    description: "Distribution géographique des zones",
    categorie: "zones",
    endpoint: "/dashboard/viz/zones-par-region",
    defaultSize: "md",
  },
  {
    id: "zones_statut_ent",
    titre: "Statut des entreprises en zone",
    description: "Installées, éligibles, etc.",
    categorie: "zones",
    endpoint: "/dashboard/viz/zones-statut-entreprises",
    defaultSize: "sm",
  },
  {
    id: "poles_par_region",
    titre: "Pôles territoriaux par région",
    description: "Distribution des pôles de développement",
    categorie: "zones",
    endpoint: "/dashboard/viz/poles-par-region",
    defaultSize: "md",
  },
  {
    id: "detail_zone",
    titre: "Détail d'une zone d'investissement",
    description: "Entreprises et stats d'une zone spécifique",
    categorie: "zones",
    endpoint: "/dashboard/viz/detail-zone",
    defaultSize: "md",
    params: [
      {
        key: "type_zone",
