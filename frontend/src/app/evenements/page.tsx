...
@keyframes pulseHaloVert{0%{box-shadow:0 0 0 0 rgba(24,128,56,0.45)}70%{box-shadow:0 0 0 9px rgba(24,128,56,0)}100%{box-shadow:0 0 0 0 rgba(24,128,56,0)}}`}</style>
      ...
      <section style={{padding:"82px 40px 18px",background:"#004f91",position:"relative" as const,overflow:"hidden"}}>
        ...
        <div style={{maxWidth:1280,margin:"0 auto",position:"relative" as const,zIndex:1,display:"flex",alignItems:"center",gap:16,minWidth:0}}>
          <span style={{width:7,height:7,borderRadius:"50%",background:"#fff",animation:"pulseDot 1.6s ease-out infinite",flexShrink:0}}/>
          ...
          {(()=>{
            ...
            return (
              <button onClick={()=>setSelec(prochain)}
                style={{marginLeft:"auto",display:"inline-flex",alignItems:"center",gap:8,padding:"6px 14px",borderRadius:999,border:"1px solid rgba(255,255,255,0.25)",background:"rgba(255,255,255,0.10)",cursor:"pointer",minWidth:0,maxWidth:440,transition:"background 0.15s",fontFamily:"var(--font-google-sans)"}}
                ...
                <span style={{fontSize:12,fontWeight:700,color:"#fff",whiteSpace:"nowrap" as const,flexShrink:0}}>Prochain événement</span>
                <span style={{fontSize:12,fontWeight:500,color:"rgba(255,255,255,0.8)",whiteSpace:"nowrap" as const,overflow:"hidden",textOverflow:"ellipsis",minWidth:0}}>
