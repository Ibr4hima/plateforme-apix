  ...
  return (
    <html lang="fr" className={googleSans.variable}>
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=all_inclusive,bookmark_stacks,close,enterprise,event,finance_mode,frame_inspect,payments,real_estate_agent,security,show_chart,signature,universal_currency_alt" />
