...
export default function EntreprisesPage() {
  ...
  const charger = useCallback(async () => {
    ...
    try {
      ...
      if (filtres.secteurs.length > 0)  params.append("secteur_nom",  filtres.secteurs.join(","));
      if (filtres.branches.length > 0)  params.append("branche_nom",  filtres.branches.join(","));
      if (filtres.activites.length > 0) params.append("activite_nom", filtres.activites.join(","));
    ...
    <main style={{ minHeight: "100vh", background: "#F2F0EF" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-google-sans)", fontWeight: 800, fontSize: "clamp(2rem, 4vw, 3rem)", color: "#1a1a2e", lineHeight: 1.1, marginBottom: 12 }}>
